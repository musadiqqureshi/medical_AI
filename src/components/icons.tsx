...
export function PaperclipIcon({ className = "h-5 w-5" }: P) {
  return (
...
export function StopIcon({ className = "h-5 w-5" }: P) {
  return (
...
export function LogoutIcon({ className = "h-4 w-4" }: P) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function ArrowRightIcon({ className = "h-5 w-5" }: P) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function HeartIcon({ className = "h-5 w-5" }: P) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function SparkleIcon({ className = "h-5 w-5" }: P) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2l1.8 5.2L19 9l-5.2 1.8L12 16l-1.8-5.2L5 9l5.2-1.8z" />
      <path d="M19 14l.9 2.6L22.5 17.5l-2.6.9L19 21l-.9-2.6L15.5 17.5l2.6-.9z" opacity="0.7" />
    </svg>
  );
}

export function BookmarkIcon({ className = "h-5 w-5" }: P) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
